...
for attr = 1:numel(attrDisplays)
    ...
    if strcmp(attrDisplay,'ALL')~=1
        ...
        title('Precision Plot','FontName','Times New Roman');
    end
    xlabel('Location Error Threshold','FontSize',20,'FontName','Times New Roman')
    ylabel('Maximum Precision Rate','FontSize',20,'FontName','Times New Roman')
    legend(legendLabel,'Location','northwest','FontSize',13,'FontName','Times New Roman');  %southeast
    axis([0 50 0 1]);  
    ...
    if strcmp(attrDisplay,'ALL')~=1
        ...
        title('Success Plot','FontName','Times New Roman');
    end
    xlabel('Overlap Threshold','FontSize',20,'FontName','Times New Roman')
    ylabel('Maximum Success Rate','FontSize',20,'FontName','Times New Roman')
    legend(legendLabel1,'FontSize',13,'FontName','Times New Roman');
    axis([0 1.0 0 1.0]);  % �����������ָ�������
