...
%% CVPR 22 
% algs = {'GlobalTrack','SPLT','mfDiMP','ADRNet','FSRPN','HMFT_LT','HMFT_LT_test2','DiMP_LTMU_RGBT'}; % ,'DiMP_LTMU_RGBT' 'DIMP_LTMU' 'HMFT_LT_test1', 'HMFT_LT_test',
% algs = {'HMFT_LT','HMFT_LT_test2','DiMP_LTMU_RGBT'};
% algs = {'SiamRPN++','SiamRPN','SiamBAN','ECO','ATOM','D3S','SiamMask','HMFT_LT','HMFT_LT_test2'};
...
for attr = 1:numel(attrDisplays)
    ...
    if strcmp(attrDisplay,'ALL')~=1
        title([' Precision Plot - ',attrName],'FontSize',12);
    else
        title('Precision Plot','FontSize',12);
    end
    ...
    if strcmp(attrDisplay,'ALL')~=1
        ...
        title('Success Plot','FontSize',12);
    end
